...
3. Show the complete diff and flag anything that could be sensitive in a public repository. Propose a commit message listing the files and noting that the rules were human-approved.
